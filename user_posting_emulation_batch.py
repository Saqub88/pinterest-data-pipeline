...
respective Kafka topics via POST APIs for further processing.
...
def run(engine):
     ...
     `post_api` function. This is repeated continuously at random time intervals
